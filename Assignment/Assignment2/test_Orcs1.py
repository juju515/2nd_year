import Assignment.Assignment2.AssII_OrcClass_v0 as testO


# testing the constructor
print("Testing the class constructor: ")
orc1 = testO.Orcs("Jack", 2.2, 4.5)
...
print(orc2.name, "str: ", orc2.strength)
print(orc3.name, "str: ", orc3.strength)
orc2.attack(orc3)
...
orc2.weapon = True
orc3.weapon = True
print(orc2.name, "skill: ", orc2.skill)
print(orc3.name, "skill: ", orc3.skill)
orc2.attack(orc3)
...
orc3.weapon = False
print(orc2.name, "has a weapon ", orc2.weapon)
print(orc3.name, "has a weapon ", orc3.weapon)
orc2.attack(orc3)
