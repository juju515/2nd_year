class Square(object):
    ...
    def getArea(self):
        """Getter for the _area attribute

           Returns:
               int representign the area of the square
        """
        return self._area
...
def main():
    ...
    print("Length of side: %i" % (square1.getLengthOfSide()))
    print("Length of perimeter: %i" % (square1.getPerimeter()))
    print("Area of square: %i" % (square1.getArea()))
